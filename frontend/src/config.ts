...
export const qualification: IQualificationChapter[] = [
  {
    ...
    items: [
      ...
      'В настоящее время прохожу обучение по программам клинической психологии (ВГАПС) и психоанализа, психоаналитической психотерапии и консультирования (МИП)',
      'Веду частную практику с 2024 года',
      'По первому образованию экономист-менеджер, кандидат экономических наук'
    ]
  },
  {
